    ...
    >
      ...
      >
        <div class="videoCover">
          ...
          />
          <div class="playCount">
            <i class="iconfont icon-shipin"></i>{{ this.handleNum(item.playCount)  }}
          </div>
          <div class="videoTime" v-if="videoType == 'singerMv'">
            {{  this.handleMusicTime(item.duration) }}
          </div>
        </div>
      ...
      >
        <div class="videoCover">
          ...
          <div class="playCount">
            ...
            >{{ this.handleNum(item.playTime || item.data.playTime)  }}
          </div>
          <div class="videoTime">
            {{ this.handleMusicTime(item.durationms || item.data.durationms) }}
          </div>
        </div>
